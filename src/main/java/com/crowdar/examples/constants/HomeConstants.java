...
public class HomeConstants {
    ...
    public static final String BTN_OPCIONES = "ACCESSIBILITY_ID:Open navigation drawer";
    public static final String BTN_LOG_OUT = "id:logoutNavDrawer";
    public static final String BTN_CONFIRM_LOG_OUT = "id:confirmation_button";
